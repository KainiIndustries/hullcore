...
peerman.addPeer(new bitcore.Peer('testnet-seed.alexykot.me', 17333));
peerman.addPeer(new bitcore.Peer('testnet-seed.bitcoin.petertodd.org', 17333));
peerman.addPeer(new bitcore.Peer('testnet-seed.bluematt.me', 17333));
